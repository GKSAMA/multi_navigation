...
bool OsqpInterface::Solve() {
    ...
    LOG(INFO) << "num_of_points_ = " << num_of_points_;
    ...
    for (int i = 0; i < num_of_points_; ++i) {
        ...
        // std::cout << x_.at(i) << " " << y_.at(i) << std::endl;
    }
...
void OsqpInterface::CalculateKernel(
...
void OsqpInterface::CalculateOffset(std::vector<c_float>* q) {
    for (int i = 0; i < num_of_points_; ++i) {
    ...
    void OsqpInterface::CalculateAffineConstraint(
...
void OsqpInterface::SetPrimalWarmStart(
    std::vector<c_float>* primal_warm_start) {
...
bool OsqpInterface::OptimizeWithOsqp(
