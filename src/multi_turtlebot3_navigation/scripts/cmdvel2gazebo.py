...
class CmdVel2Gazebo:
    def __init__(self,namespace):
        ...
        self.pub_rearL = rospy.Publisher(namespace+'/left_rear_velocity_controller/command', Float64, queue_size=1)
        self.pub_rearR = rospy.Publisher(namespace+'/right_rear_velocity_controller/command', Float64, queue_size=1)
